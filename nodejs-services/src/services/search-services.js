...
dispatcher.onGet(/\//, function(request, response) {
    ...
    makeWebRequest("search-api", "8080", "/search-api/" + endpoint, lodash.random(0, 75), function(err) {
        
        var url = "http://search-api:8080/search-api/" + endpoint;
        ...
        if (err) {
            ...
            makeWebRequest("caching-services", "8080", "/caching-services/" + endpoint, lodash.random(0, 75), function(err2) {
                
                var url2 = "http://caching-services:8080/caching-services/" + endpoint;
